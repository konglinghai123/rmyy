...
<script type="text/javascript">
	$(function(){
		$('#tt').datagrid({
			url:'${ctx}/card/manage/patientbaseinfo/query',
			toolbar:'#tb',
			fit:true,
			nowrap:true,
			pagination:true,
			...
			onExpandRow: function(rowIndex, rowData){
				$('#ddv-' + rowIndex).panel({
					border:false,
					cache:false,
					content: '<iframe src="${ctx}/card/manage/practicecard/' + rowData.id + '/detail" frameborder="0" width="100%" height="200px" scrolling="auto"></iframe>',
					onLoad:function(){
