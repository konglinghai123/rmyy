...
<ewcms:head title="发诊疗卡"/>
	<div id="edit-from" class="easyui-layout" data-options="fit:true,bordar:false">
		...
		<div data-options="region:'center',border:false">	
		 	<form:form id="editForm" action="${ctx}/card/manage/practicecard/savedeposit" method="post" commandName="m"  class="form-horizontal">
		    	...
		    	<c:forEach var="selection" items="${selections}">
			  	...
			  	<table class="formtable">
				  		...
				  		<td width="100%" colspan="6" style="padding:0px;">
				  			<table width="100%">
					        	<tr>
							  		...
							  		<td><form:label path="deposit"></form:label><form:checkbox path="deposit" label="收取押金（1元）"/></td>
		        	...
		        	<tr>
				  		<td widht="80"><form:label path="patientBaseInfo.name">姓名：</form:label></td>
...
<script type="text/javascript">
	$(function(){
		...
		$('#readPatientByCertificate').bind('click', function(){
			 	 $.ajax({url:"${ctx}/card/manage/patientbaseinfo/readpatient",
				 async:false,
				 type:'get',
				 dataType:"json",
