...
<ewcms:head title="编辑 -性别字典"/>
	<div id="edit-from" class="easyui-layout" data-options="fit:true,bordar:false">
		<ewcms:showMessage/>
		<div data-options="region:'center',border:false">	
		 	<form:form id="editForm" action="${ctx}/empi/dictionary/countrycode/save" method="post" commandName="m"  class="form-horizontal">
	    ...
	    <c:choose>
	    	...
	    	<c:otherwise>
				$.validationEngineLanguage.allRules.ajaxNameCall= {
	                "url": "${ctx}/empi/dictionary/countrycode/validate",
