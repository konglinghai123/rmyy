...
document
		.write('<div id="loading_mask_msg" style="position: absolute; cursor1: wait; top:'
				+ ((document.documentElement.clientHeight - 110) / 2)
				+ 'px;left:'
				+ ((document.documentElement.clientWidth - 180) / 2)
				+ 'px;  padding: 12px 5px 10px 30px; background: #fff url() no-repeat scroll 5px 10px; border: 2px solid #6593CF; color: #222; display: block;font-size:14px;">页面正在加载，请稍候。。。</div>');
