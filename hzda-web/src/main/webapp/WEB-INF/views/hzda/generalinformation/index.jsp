	...
	<table id="tt" class="easyui-datagrid" data-options="url:'${ctx}/hzda/generalinformation/query',toolbar:'#tb',fit:true,nowrap:true,pagination:true,rownumbers:true,striped:true,border:false,pageSize:20">
		<thead>
			<tr>
				...
				<th data-options="field:'birthday',sortable:true,width:140">出生年月</th>
				<th data-options="field:'nation.name',sortable:true,width:100,
						formatter:function(val,row){
							return row.nation==null?'':row.nation.name;
						}">民族</th>
				<th data-options="field:'degreeEducation',sortable:true,width:120">文化程度</th>
				<th data-options="field:'occupation',sortable:true,width:120">职业</th>
				<th data-options="field:'address',sortable:true,width:160">现住址</th>
				...
				<th data-options="field:'certificateNumber',sortable:true,width:160">证件号</th>
				<th data-options="field:'medicalInsuranceNumber',sortable:true,width:100">医保号</th>
				<th data-options="field:'mobilePhoneNumber',sortable:true,width:100">手机号码</th>
				<th data-options="field:'otherTelephone',sortable:true,width:100">其他联系电话</th>
				<th data-options="field:'remakrs',sortable:true,width:160,formatter:formatTooltip">备注</th>
			</tr>
		</thead>
	</table>
        ...
        <div>
        	<form id="queryform" style="padding:0;margin:0;">
        		<table class="formtable">
              		<tr>
              			<td width="5%">姓名</td>
              			<td width="23%"><input type="text" name="LIKE_name" style="width:120px;"/></td>
              			<td width="5%">手机号码</td>
