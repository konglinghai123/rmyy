...
<ewcms:head/>
	...
	<div id="tb" style="padding:5px;height:auto;">
		...
		<div class="toolbar" style="margin-bottom:2px">
			<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="$.ewcms.add({src:'${ctx}/hzda/fracture/save/${generalInformationId}',title:'新增',width:780,height:360,left:100});">新增</a>
			<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="$.ewcms.edit({src:'${ctx}/hzda/fracture/save/${generalInformationId}',title:'修改',width:780,height:360,left:100});">修改</a>
