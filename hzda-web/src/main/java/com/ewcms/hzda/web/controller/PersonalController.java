...
import com.ewcms.hzda.service.PersonalService;
import com.ewcms.hzda.web.controller.util.HzdaUtil;
import com.ewcms.security.user.entity.User;
import com.ewcms.security.user.web.bind.annotation.CurrentUser;

@Controller
@RequestMapping(value = "/hzda/personal")
public class PersonalController extends BaseCRUDController<Personal, Long> {
	...
	public String showSaveForm(@CurrentUser User user,
		...
		Personal personal = getPersonalService().findByGeneralInformationId(generalInformation.getId());
		if (personal == null) {
			personal = new Personal();
		}
		model.addAttribute("generalInformationId", generalInformation.getId());
		model.addAttribute("m", personal);
	...
	public String save(Model model, Personal m, BindingResult result, List<Long> selections) {
		throw new RuntimeException("discarded method");
	}

	@RequestMapping(value = "save/{generalInformationId}", method = RequestMethod.POST)
	public String save(Model model, @Valid @ModelAttribute("m") Personal m, BindingResult result, @CurrentUser User user, @PathVariable(value = "generalInformationId") GeneralInformation generalInformation, RedirectAttributes redirectAttributes) {
