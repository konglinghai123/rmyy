 ...
 * @author wu_zhijun
 */
public abstract class BaseSequenceMovableController<M extends BaseSequenceEntity<ID> & Movable, ID extends Serializable> extends BaseCRUDController<M, ID> {

    protected BaseSequenceMovableService<M, ID> getMovableService() {
        return (BaseSequenceMovableService<M, ID>) baseService;
    }
