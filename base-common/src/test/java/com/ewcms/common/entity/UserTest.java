...
public class UserTest extends BaseEntity<Long> implements LogicDeleteable {
    ...
    private UserStatusTest status = UserStatusTest.normal;
    ...
    public UserStatusTest getStatus() {
        return status;
    }

    public void setStatus(UserStatusTest status) {
        this.status = status;
    }
