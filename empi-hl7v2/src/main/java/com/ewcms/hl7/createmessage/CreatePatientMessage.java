...
public class CreatePatientMessage {
	...
	public static String createPatient(PatientBaseInfo patientBaseInfo, String practiceNo, String version) throws HL7Exception, IOException {
		...
		String sourcePlace = patientBaseInfo.getSourcePlace(); // 来源地 未设置PID值
		String certificateType = patientBaseInfo.getCertificateType(); // 证件类别  未设置PID值
		...
		Hl7v2Encode hl7v2Encode = new Hl7v2Encode(practiceNo, id, contactName,
				birthday, sex, nation, contactAddress, nationlity,
				contactTelephone, maritalStatus, certificateNo, medicalAccount);
