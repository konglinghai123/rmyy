...
public class DrugFormService extends BaseService<DrugForm, Long> {
	...
	public String findOrganizationNames(String commonName, int administrationId){
		return getDrugFormRepository().findOrganizationNames(commonName, administrationId);
	}
	/**
...
//	}
	...
	private Boolean isDeclareTotalUpperLimt(Long userId) {
		...
		if (systemParameter.getDeclareTotalLimt() ==0||declareTotal < systemParameter.getDeclareTotalLimt()) {//0表示不受限制或总数没达到上限
...
//	}
	...
	public Map<String, Object> findDrugFormCount(User user, Long systemParameterId, SearchParameter<Long> searchParameter) {
