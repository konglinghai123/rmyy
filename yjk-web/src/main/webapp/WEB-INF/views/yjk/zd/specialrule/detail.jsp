...
<ewcms:head title="字典-通用名"/>
	...
	<div id="tb" style="padding:5px;height:auto;">
        <div class="toolbar" style="margin-bottom:2px">
			<a id="tb-add" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'" onclick="$.ewcms.add({src:'${ctx}/yjk/zd/specialrule/${specialRuleId}/save',title:'新增',width:600,height:365});">新增</a>
 			<a id="tb-remove" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-remove'" onclick="$.ewcms.remove({src:'${ctx}/yjk/zd/specialrule/${specialRuleId}/delete',title:'删除'});">删除</a>
		</div>
        <div>
        </div>
	</div>
