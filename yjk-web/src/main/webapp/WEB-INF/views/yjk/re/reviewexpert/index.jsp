...
<ewcms:head title="评审-评审专家"/>
	...
	<div id="tb" style="padding:5px;height:auto;">
        <div class="toolbar" style="margin-bottom:2px">
			...
			<a id="tb-edit" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-edit'" onclick="$.ewcms.edit({src:'${ctx}/yjk/re/reviewexpert/${reviewMainId}/save',title:'修改',width:850,height:450});">修改</a>
