...
<ewcms:head title="评审-用户选择" />
<div id="edit-from" class="easyui-layout" data-options="fit:true" style="border: 0;">
	<ewcms:showMessage />
	<div data-options="region:'center',border:false">
		<form:form id="editForm" method="post" action="${ctx}/yjk/re/reviewmain/${reviewMainId}/saveUser" class="form-horizontal">
...
<script type="text/javascript">
	$(function() {
		var transTool = $('#cc_userIds').combogrid({
            ...
            fitColumns: true,
            pagination:true,
            url:'${ctx}/yjk/re/reviewmain/canUseUser',
            queryParams:{name:''},
            columns: [[
