	...
	<div id="tb" style="padding:5px;height:auto;">
		<div style="margin-bottom:2px">
			...
			<a id="tb-status" href="javascript:void(0);" class="easyui-menubutton" data-options="menu:'#menu-status',iconCls:'icon-status'">状态</a>
 			<a id="tb-import" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-zip-import',toggle:true" onclick="$.ewcms.openWindow({windowId:'#edit-window',width:500,height:350,title:'导入用户信息',src:'${ctx}/security/user/user/import'});">导入</a>
		</div>
