...
<ewcms:head title="字典-技术职称(资格)"/>
	<table id="tt" class="easyui-datagrid" data-options="url:'${ctx}/security/dictionary/technicalTitle/query',toolbar:'#tb',fit:true,nowrap:true,pagination:true,rownumbers:true,striped:true,border:false,pageSize:20">
		<thead>
			<tr>
