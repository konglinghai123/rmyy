...
ArticleToolbar.prototype.addFontColor = function(){
	...
	this.Html.push("<td style='height:17px;'><img src='" + ctx + "/static/image/notice/spacer.gif' style='background-position: 0px -704px; background-image: url(" + ctx + "/static/image/notice/fck_strip.gif);overflow: hidden;width: 14px;height: 14px;margin: 0px;'></td>");
	this.Html.push("<td style='height:17px;'><img height='3' width='5' src='" + ctx + "/static/image/notice/toolbar.buttonarrow.gif'></td>");
...
ArticleToolbar.prototype.addBold = function(){
	...
	this.Html.push("<img src='" + ctx + "/static/image/notice/spacer.gif' style='background-position: 0px -304px; background-image: url(" + ctx + "/static/image/notice/fck_strip.gif);overflow: hidden;width: 14px;height: 14px;margin: 1px;'>");
	this.Html.push("</div></td>");
};
...
ArticleToolbar.prototype.addItalic = function(){
	...
	this.Html.push("<img src='" + ctx + "/static/image/notice/spacer.gif' style='background-position: 0px -320px; background-image: url(" + ctx + "/static/image/notice/fck_strip.gif);overflow: hidden;width: 14px;height: 14px;margin: 1px;'>");
	this.Html.push("</div></td>");
};
...
ArticleToolbar.prototype.addUnderLine = function(){
	...
	this.Html.push("<img src='" + ctx + "/static/image/notice/spacer.gif' style='background-position: 0px -336px; background-image: url(" + ctx + "/static/image/notice/fck_strip.gif);overflow: hidden;width: 14px;height: 14px;margin: 1px;'>");
	this.Html.push("</div></td>");
};
